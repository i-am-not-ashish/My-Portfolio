      ...
      <div className="row py-3" style={Style2}>
        <div className="col ">
          <div className="card px-2" style={Style3}>
            ...
            <div className="card-body">
              <h3 className="card-title px-2 py-1 border-black rounded border-bottom" style={Style5}>Home Automation</h3>
        ...
        <div className="col">
          <div className="card px-2" style={Style3}>
            ...
            <div className="card-body">
              <h3 className="card-title px-2 py-1 border-black rounded border-bottom" style={Style5}>Light Intensity Detection System</h3>
      ...
      <div className="row py-3" style={Style2}>
        <div className="col">
          <div className="card px-2" style={Style3}>
            ...
            <div className="card-body">
              <h3 className="card-title px-2 py-1 border-black rounded border-bottom" style={Style5}>Fire Alarm</h3>
        ...
        <div className="col">
          <div className="card px-2" style={Style3}>
            ...
            <div className="card-body">
              <h3 className="card-title px-2 py-1 border-black rounded border-bottom" style={Style5}>DC Motor Speed and Direction Control</h3>
      ...
      <div className="row py-3" style={Style2}>
        <div className="col">
          <div className="card px-2" style={Style3}>
            ...
            <div className="card-body">
              <h3 className="card-title px-2 py-1 border-black rounded border-bottom" style={Style5}>News Cat</h3>
        ...
        <div className="col" >
          <div className="card px-2" style={Style3}>
            ...
            <div className="card-body">
              <h3 className="card-title px-2 py-1 border-black rounded border-bottom" style={Style5}>Text-Utils</h3>
